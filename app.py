...
Original file is located at
    https://colab.research.google.com/drive/10T5JKwIe8Kcws6AoSz0kl3b9nASA42GJ
"""
...
with tab1:
    ...
    if image:
        ...
        if image_type not in ['jpg','jpeg','png','jfif']:
            ...
            label = prediction("best_model_mobilenetV2.h5", image)
...
with tab2:
    ...
    if cam_image:
        ...
        #getting the predictions
        label = prediction("best_model_mobilenetV2.h5", cam_image)
